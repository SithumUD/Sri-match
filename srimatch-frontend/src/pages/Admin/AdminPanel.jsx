        ...
        <div className="ap-tables-row">
          ...
          <div className="ap-card">
            <div className="ap-card-header">
              ...
              <Link to="/admin/users" className="ap-view-all">View All <ArrowRightIcon size={12} /></Link>
            </div>
          ...
          <div className="ap-card">
            <div className="ap-card-header">
              ...
              <Link to="/admin/payments" className="ap-view-all">View All <ArrowRightIcon size={12} /></Link>
            </div>
            <table className="ap-table">
              <thead>
                <tr>
