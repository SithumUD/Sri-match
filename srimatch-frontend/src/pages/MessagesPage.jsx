...
const MessagesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f4] px-4 py-8 sm:px-6 lg:px-8 font-['DM_Sans']">
      <Helmet>
        <title>Messages | SriMatch</title>
        <meta name="description" content="Secure private messaging for SriMatch members." />
      </Helmet>
            ...
            <div className="p-7">
              ...
              {reportSuccess ? (
                ...
                <form onSubmit={handleReport}>
                  ...
                  <div className="mb-7">
                    <label className="mb-1.5 block text-[0.75rem] font-semibold text-[#8b4e2e] uppercase tracking-wide">Description</label>
                    <textarea 
