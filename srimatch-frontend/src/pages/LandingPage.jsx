        ...
        <nav className="lp-nav">
          <div className="lp-nav-inner">
            ...
            <div className="lp-nav-links">
              <Link to="/login" className="lp-nav-link-ghost">Sign In</Link>
              <Link to="/register" className="lp-nav-cta">Join Free ✦</Link>
            </div>
          </div>
        </nav>
          ...
          <div className="lp-section-inner">
            <div className="lp-premium-grid">
              ...
              <div className="lp-premium-text">
                ...
                <Link to="/register" className="lp-btn-gold" style={{ display: "inline-flex" }}>
