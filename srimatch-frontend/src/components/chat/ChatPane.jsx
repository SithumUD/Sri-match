    ...
    <div className="flex flex-col flex-1 h-full overflow-hidden bg-white">
      ...
      <header className="flex items-center gap-3.5 px-6 py-4 border-b border-[#f5ede8] bg-gradient-to-br from-[#fdf5ee] to-[#faf0f8] flex-shrink-0">
        ...
        <div className="flex gap-1">
          <button 
            className="h-9 w-9 rounded-full flex items-center justify-center text-[#9a7060] border border-[#f0ddd5] hover:border-[#c9856a] hover:text-[#8b4e2e] hover:bg-[#fdf0e8] transition-all"
            onClick={onReport}
            title="Report User"
          >
            <Flag size={15} />
      ...
      {!isPremium && (
        <div className="bg-gradient-to-br from-[#3d1f12] to-[#6b3526] px-6 py-2.5 flex items-center justify-between gap-4 text-white/90 text-[0.77rem] flex-shrink-0">
          ...
          <Link to="/subscription" className="bg-gradient-to-br from-[#e8c97a] to-[#c9a050] text-[#3d1f12] px-3.5 py-1 rounded-full font-semibold text-[0.74rem] no-underline">
            Upgrade ✦
          </Link>
        </div>
      )}
      ...
      <div className="p-4 border-t border-[#f5ede8] bg-white flex-shrink-0">
        ...
        >
          <div className="flex gap-0.5">
            <button type="button" className="h-9 w-9 flex items-center justify-center text-[#b09080] hover:text-[#8b4e2e] hover:bg-[#fdf0e8] rounded-full transition-all">
              <Smile size={18} />
            </button>
            <button type="button" className="h-9 w-9 flex items-center justify-center text-[#b09080] hover:text-[#8b4e2e] hover:bg-[#fdf0e8] rounded-full transition-all">
              <Paperclip size={18} />
          ...
          <button 
            type="submit" 
            className="h-10 w-10 flex-shrink-0 flex items-center justify-center rounded-full bg-gradient-to-br from-[#3d1f12] via-[#8b4e2e] to-[#c9856a] text-white shadow-[0_4px_12px_rgba(139,78,46,0.28)] transition-all hover:scale-105 hover:shadow-[0_6px_16px_rgba(139,78,46,0.36)] disabled:opacity-40 disabled:cursor-not-allowed disabled:scale-100"
