        ...
        <div className="ft-main">
          ...
          <div>
            ...
            <nav className="ft-links">
              ...
              <Link to="/how-it-works" className="ft-link">How It Works</Link>
              <Link to="/success-stories" className="ft-link">Success Stories</Link>
              ...
              <Link to="/press" className="ft-link">Press & Media</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="ft-links">
              <Link to="/register" className="ft-link">Join Free</Link>
              <Link to="/subscription" className="ft-link">Premium Plans</Link>
              <Link to="/verification" className="ft-link">NIC Verification</Link>
              <Link to="/horoscope" className="ft-link">Horoscope Matching</Link>
              <Link to="/profile-boost" className="ft-link">Profile Boost</Link>
              <Link to="/gifting" className="ft-link">Send a Gift</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="ft-links">
              <Link to="/help-center" className="ft-link">Help Centre</Link>
              <Link to="/faq" className="ft-link">FAQ</Link>
              <Link to="/safety-guidelines" className="ft-link">Safety Guidelines</Link>
              <Link to="/report" className="ft-link">Report a Profile</Link>
              <Link to="/customer-support" className="ft-link">Customer Support</Link>
              <Link to="/accessibility" className="ft-link">Accessibility</Link>
            </nav>
          </div>
        ...
        <div className="ft-bottom">
          <div className="ft-bottom-inner">
            ...
            <div className="ft-legal-links">
              <Link to="/terms" className="ft-legal-link">Terms of Service</Link>
              <Link to="/privacy" className="ft-legal-link">Privacy Policy</Link>
              <Link to="/cookie-policy" className="ft-legal-link">Cookie Policy</Link>
              <Link to="/refund-policy" className="ft-legal-link">Refund Policy</Link>
            </div>
          </div>
        </div>
