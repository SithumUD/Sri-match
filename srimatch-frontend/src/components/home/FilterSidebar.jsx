      ...
      <div className="max-h-[calc(100vh-120px)] overflow-y-auto px-6 py-5 scrollbar-thin scrollbar-thumb-[#e8c9b8] scrollbar-track-transparent">
        {!isPremium && (
          <div className="mb-5 rounded-xl border border-[#f0ddd5] bg-gradient-to-br from-[#fdf5ee] to-[#fdf0e8] p-4">
            ...
            <Link to="/subscription" className="inline-block rounded-full bg-gradient-to-br from-[#3d1f12] via-[#8b4e2e] to-[#c9856a] px-4 py-1.5 text-[0.75rem] font-medium text-white no-underline transition-opacity hover:opacity-90">
              Upgrade Now ✦
            </Link>
          </div>
        )}
        ...
        <div className="mb-[1.1rem]">
          ...
          <label className="mb-1 block text-[0.77rem] font-medium text-[#4a3028]">District</label>
          <select 
            name="district" 
          ...
          <label className="mb-1 block text-[0.77rem] font-medium text-[#4a3028]">City</label>
          <input 
