  ...
  const successStories = [
    {
      ...
      location: "Colombo",
      story:
        "We matched on SriMatch in January 2022. After chatting for two weeks, we decided to meet at a café in Colombo. The connection was immediate! Our families were thrilled when they discovered how compatible our values and life goals were. We got married in a traditional ceremony in December 2022 and are now expecting our first child. Thank you SriMatch for bringing us together!",
      image:
        "https://images.unsplash.com/photo-1529519195486-16945f0fb37d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGluZGlhbiUyMGNvdXBsZXxlbnwwfHwwfHx8MA%3D%3D&auhref=format&fit=crop&w=500&q=60",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1518621736915-f3b1c41bfd00?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGluZGlhbiUyMGNvdXBsZXxlbnwwfHwwfHx8MA%3D%3D&auhref=format&fit=crop&w=500&q=60",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1591604466107-ec97de577aff?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aW5kaWFuJTIwY291cGxlfGVufDB8fDB8fHww&auhref=format&fit=crop&w=500&q=60",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1623596711744-1cfa5e4321e0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGluZGlhbiUyMGNvdXBsZXxlbnwwfHwwfHx8MA%3D%3D&auhref=format&fit=crop&w=500&q=60",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1537390238848-0da5991e7c4a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8aW5kaWFuJTIwY291cGxlfGVufDB8fDB8fHww&auhref=format&fit=crop&w=500&q=60",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1583889659384-6d9b2196f2ba?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8aW5kaWFuJTIwY291cGxlfGVufDB8fDB8fHww&auhref=format&fit=crop&w=500&q=60",
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-16">
            <div className="md:flex">
              <div className="md:w-1/2">
                <img
                  src="https://images.unsplash.com/photo-1513279922550-250c2129b13a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aW5kaWFuJTIwd2VkZGluZ3xlbnwwfHwwfHx8MA%3D%3D&auhref=format&fit=crop&w=800&q=60"
              ...
              <div className="md:w-1/2 p-8">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  beginning, which was important to both of us. The cultural and background compatibility features were particularly valuable to our parents!"
                </p>
                <p className="text-gray-600 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="aspect-w-16 aspect-h-9 bg-gray-200 relative">
                  <img
                    src="https://images.unsplash.com/photo-1511424323603-701a9fa269be?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8aW5kaWFuJTIwY291cGxlfGVufDB8fDB8fHww&auhref=format&fit=crop&w=500&q=60"
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="aspect-w-16 aspect-h-9 bg-gray-200 relative">
                  <img
                    src="https://images.unsplash.com/photo-1609439547168-c973842210e1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGluZGlhbiUyMGNvdXBsZXxlbnwwfHwwfHx8MA%3D%3D&auhref=format&fit=crop&w=500&q=60"
                    alt="Video Testimonial"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="aspect-w-16 aspect-h-9 bg-gray-200 relative">
                  <img
                    src="https://images.unsplash.com/photo-1565677913671-ce5a5c0ae655?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGluZGlhbiUyMGNvdXBsZXxlbnwwfHwwfHx8MA%3D%3D&auhref=format&fit=crop&w=500&q=60"
                    alt="Video Testimonial"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
