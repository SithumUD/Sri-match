/**
 * profileEnums.ts — Single source of truth for all profile enum option arrays.
 * Both ProfileCreationPage and MyProfilePage import from here.
...
export const COMPLETION_WEIGHTS = {
  photos:            10,  // >= 1 photo
  about:             10,  // > 50 chars
  interests:         10,  // >= 3 selected
  city:              10,
  partnerPreferences: 10, // any field set
  education:          8,
  profession:         8,
  religion:           8,
  maritalStatus:      6,
...
// ─── Compatibility Quiz — canonical 29 questions / 10 categories (§5.1) ──────

export const QUIZ_TOTAL_QUESTIONS = 29;

export const QUIZ_CATEGORIES = [
  { id: "values_beliefs",       emoji: "🌍", label: "Values & Beliefs" },
  { id: "relationship_goals",   emoji: "💍", label: "Relationship Goals" },
  { id: "family_lifestyle",     emoji: "🏡", label: "Family & Lifestyle" },
  { id: "career_money",         emoji: "💼", label: "Career & Money" },
  { id: "location_future",      emoji: "📍", label: "Location & Future" },
  { id: "personality_lifestyle", emoji: "❤️", label: "Personality & Lifestyle" },
  { id: "habits",               emoji: "🚬", label: "Habits" },
  { id: "relationship_style",   emoji: "💞", label: "Relationship Style" },
  { id: "children_responsibility", emoji: "🧒", label: "Children & Responsibility" },
  { id: "modern_factors",       emoji: "📱", label: "Modern Factors" },
];
