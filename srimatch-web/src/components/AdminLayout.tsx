...
const NAV_ITEMS = [
  ...
  { name: "TikTok Promotions",   path: "/admin/tiktok-promotions", icon: <Video size={16} /> },
];
...
const PAGE_TITLES = {
  ...
  "/admin/tiktok-promotions": "TikTok Promotions",
};
    ...
    <>
      ...
      <div className="al-root">
        ...
        <aside className={`al-sidebar${sidebarOpen ? " open" : ""}`}>
          ...
          {/* Brand */}
          <Link href="/admin" className="al-brand" onClick={closeSidebar}>
