...
/* ─── Nav links config ─────────────────────────────────────────────────── */
const NAV_LINKS = [
  { href: "/home", icon: Search, label: "Browse" },
...
const Navbar = () => {
  ...
  const { data: subscription = {} }: any = useSubscription();
    ...
    <>
      ...
      <nav className="nb-root">
        <div className="nb-inner">
          ...
          {/* Logo */}
          <Link href={isAuthenticated ? "/home" : "/"} className="nb-logo">
          ...
          <div className="nb-right">
            {isAuthenticated ? (
              <>
                {/* Subscription Status */}
                <Link href="/subscription" className="nb-sub-badge">
                ...
                <div className="nb-avatar-wrap" ref={dropdownRef}>
                  ...
                  {isDropdownOpen && (
                    <div className="nb-dropdown">
                      ...
                      {!isPremium && (
                        <Link href="/subscription" className="nb-dropdown-premium" onClick={() => setIsDropdownOpen(false)}>
                          <Crown size={13} style={{ color: "#e8c97a" }} />
                          Upgrade to Premium ✦
                        </Link>
                      )}

                      <Link href="/my-profile" className="nb-dropdown-item" onClick={() => setIsDropdownOpen(false)}>
                        <User size={14} style={{ color: "#8b4e2e" }} /> My Profile
                      </Link>
                      <Link href="/verification" className="nb-dropdown-item" onClick={() => setIsDropdownOpen(false)}>
                        <Heart size={14} style={{ color: "#8b4e2e" }} /> Verification
                      </Link>
                      <Link href="/settings" className="nb-dropdown-item" onClick={() => setIsDropdownOpen(false)}>
              ...
              <div className="nb-auth">
                <Link href="/login" className="nb-login">Sign In</Link>
                <Link href="/register" className="nb-join">Join Now ✦</Link>
              </div>
            )}
          </div>
        ...
        <div className="nb-drawer">
          ...
          <div className="nb-drawer-panel">
            ...
            <div className="nb-drawer-links">
              {NAV_LINKS.map(({ href, icon: Icon, label }) => (
                <Link key={href} href={href} className={`nb-drawer-link${isActive(href) ? " active" : ""}`}>
                  <Icon size={16} style={{ color: isActive(href) ? "#8b4e2e" : "#c4a99a" }} />
                  {label}
                </Link>
              ))}
              ...
              <Link href="/my-profile" className={`nb-drawer-link${isActive("/my-profile") ? " active" : ""}`}>
                <User size={16} style={{ color: "#c4a99a" }} /> My Profile
              </Link>
              <Link href="/verification" className={`nb-drawer-link${isActive("/verification") ? " active" : ""}`}>
                <Heart size={16} style={{ color: "#c4a99a" }} /> Verification
              </Link>
              <Link href="/settings" className={`nb-drawer-link${isActive("/settings") ? " active" : ""}`}>
            ...
            <div className="nb-drawer-footer">
              {!isPremium && (
                <Link href="/subscription" className="nb-drawer-premium">
