...
public class CloudflareR2Config {
    ...
    public S3Client r2S3Client() {
        if (accountId == null || accountId.isBlank() || accessKeyId == null || accessKeyId.isBlank() || secretAccessKey == null || secretAccessKey.isBlank()) {
            log.warn("Cloudflare R2 is enabled but credentials (account-id, access-key-id, secret-access-key) are incomplete. S3Client will not be initialized.");
            return null;
        }
